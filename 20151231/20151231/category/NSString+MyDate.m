...
+(NSInteger)getCountDayBetweenDate:(NSDate *)date withBugetDay:(NSString *)bugetDay{
    ...
    NSInteger duratTiome = fabs([newdate1 timeIntervalSinceDate:newdate]);
...
{
    NSString *birthYear = [NSString year:birthdayDate];
    NSString *ageYear = [NSString year:[NSDate date]];
    
    return [NSString stringWithFormat:@"%ld",[ageYear integerValue]-[birthYear integerValue]];
